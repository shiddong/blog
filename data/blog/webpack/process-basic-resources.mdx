...
> webpack 5 对图片、字体等资源的解析方式发生了变化，可以查看 [资源模块](https://webpack.docschina.org/guides/asset-modules#inlining-assets)
>
> 如果是使用 webpack 4，则可以参考下面的解析方式，当然在 webpack 5 中也支持该解析方式
