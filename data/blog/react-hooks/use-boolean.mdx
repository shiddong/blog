---
title: React Hooks 的实现 - usBoolean
date: '2022-09-08'
tags: ['react-hooks']
draft: false
summary: 实现一个可以两个 Boolean 值状态之间切换 hook.
---

# 实现需求

实现一个可以两个 Boolean 值状态之间切换 hook.
...
主要参考 react-use 与 ahooks 的实现方式。

这两个仓库提供了两个这样的 hook，分别是 useBoolean 与 useToogle，其基本设计是相同的，具体看下面的介绍。
